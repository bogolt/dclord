...
CancelBuildUnits, EVT_BUILD_CANCEL = wx.lib.newevent.NewEvent()
UserEnable, EVT_USER_ENABLE = wx.lib.newevent.NewEvent()
StoreAction, EVT_STORE_ACTION = wx.lib.newevent.NewEvent()
CancelAction, EVT_CANCEL_ACTION = wx.lib.newevent.NewEvent()
